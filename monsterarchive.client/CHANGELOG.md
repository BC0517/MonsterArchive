...
- Create Angular project with ng: `ng new monsterarchive.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`monsterarchive.client.esproj`).
